...
# Generic ARMv8
################################################################################
SRC_URI = "repo://github.com/xen-troops/manifests;protocol=https;branch=REL-v6.0;manifest=prod_devel/dom0.xml;scmdata=keep"
...
XT_QUIRK_UNPACK_SRC_URI += "\
    ...
    file://xen-version.inc;subdir=repo/meta-xt-prod-domx/inc \
"
